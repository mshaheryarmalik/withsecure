...
from security_research_agent.configuration import Configuration, SearchAPI
from security_research_agent.prompts import summarize_webpage_prompt
from security_research_agent.state import ResearchComplete, Summary
...
async def get_search_tool(search_api: SearchAPI):
    ...
    Args:
        search_api: The search API provider to use (Google, Tavily, or None)
        
    Returns:
        List of configured search tool objects for the specified provider
    """
    if search_api == SearchAPI.GOOGLE:
        # Google/Gemini native search grounding
        # Note: This uses Gemini's built-in search capabilities
        return []  # Gemini handles search natively when configured
...
##########################
# Note: Gemini-only implementation - native search detection not currently needed
...
def is_token_limit_exceeded(exception: Exception, model_name: str = None) -> bool:
    ...
    """
    # Only checking Gemini token limits (Gemini-only implementation)
