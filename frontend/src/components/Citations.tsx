...
export function Citations({ isProcessing, logs, isOpen, onClose }: CitationsProps) {
  ...
  const citations: {
    ...
    { id: '1', title: "NVD - CVE-2021-44228", url: "https://nvd.nist.gov/vuln/detail/CVE-2021-44228", domain: "nvd.nist.gov" },
    { id: '2', title: "Apache Log4j Security Vulnerabilities", url: "https://logging.apache.org/log4j/2.x/security.html", domain: "apache.org" },
    { id: '3', title: "CISA Log4Shell Guidance", url: "https://www.cisa.gov/log4shell", domain: "cisa.gov" },
    { id: '4', title: "CVE Details - Apache Log4j2", url: "https://www.cvedetails.com/product/44998/Apache-Log4j.html", domain: "cvedetails.com" },
    { id: '5', title: "NIST National Vulnerability Database", url: "https://nvd.nist.gov", domain: "nvd.nist.gov" },
    { id: '6', title: "Snyk Vulnerability Database", url: "https://security.snyk.io/vuln/SNYK-JAVA-ORGAPACHELOGGING", domain: "snyk.io" },
    { id: '7', title: "GitHub Security Advisories", url: "https://github.com/advisories", domain: "github.com" },
    { id: '8', title: "MITRE CVE Database", url: "https://cve.mitre.org", domain: "mitre.org" },
    { id: '9', title: "SOC 2 Compliance Framework", url: "https://www.aicpa.org/soc2", domain: "aicpa.org" },
    { id: '10', title: "OWASP Top 10 Vulnerabilities", url: "https://owasp.org/www-project-top-ten", domain: "owasp.org" }
  ];
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'active': return 'text-slate-400';
        ...
        <div className="sticky top-0 z-10 bg-black/60 backdrop-blur-md border-b border-slate-700 px-6 py-4 relative">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-sm text-slate-400 font-mono">Real-time processing events</p>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="overflow-y-auto h-full pb-20 px-6 py-4">
          {logs.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 text-center">
              ...
              <p className="text-sm text-slate-400 font-mono">Waiting for analysis...</p>
              <p className="text-xs text-slate-500 mt-2 font-mono">Activity will appear here</p>
            </div>
          ) : (
            <>
              {/* Sources Dropdown */}
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-xs text-slate-500 font-mono">{citations.length} sources reviewed</div>
                    </div>
                  </div>
                  <ChevronDown className={`w-4 h-4 text-slate-400 transition-transform ${showSources ? 'rotate-180' : ''}`} />
                </button>
                    ...
                    {displayedCitations.map((citation, index) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-xs text-slate-500 font-mono">{citation.domain}</div>
                        </div>
                      </a>
                    ))}
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-baseline gap-2 mb-1">
                          ...
                          <span className="text-xs text-slate-400 font-mono">{log.nodeLabel}</span>
                        </div>
                        <div className="text-sm text-slate-300 font-mono">{log.message}</div>
                      </div>
                    </div>
                  ))}
                  <div ref={logsEndRef} />
